...
Costruito come ospite del gruppo **Giuristi AI** per provare un'idea. Niente è ancora deciso: il nome, l'aspetto, le categorie, la moderazione, il dominio finale — **tutto è da discutere insieme**. Se l'idea regge, questa organizzazione GitHub e l'eventuale dominio passano a chi gestisce il gruppo.
